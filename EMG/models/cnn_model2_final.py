...
class CNN(nn.Module):
  def __init__(self):
    super().__init__()
    self.conv1=nn.Conv2d(12,16,2,1,padding=1)
    self.conv2=nn.Conv2d(16,64,2,1,padding=1)
    #self.conv3=nn.Conv2d(32,64,2,1,padding=1)
    #fully connected layers
    self.fc1=nn.Linear(2*4*64 ,120)
    self.fc2=nn.Linear(120,20)
    self.fc3=nn.Linear(20,14)

  def forward(self,x):
    x=F.relu(self.conv1(x))
    x=F.max_pool2d(x,2,2) #2*2 kernel and stride of 2
    ...
    #flatten the data
    x=x.reshape(-1,64*2*4)  #-1 so that we can vary the batch size
